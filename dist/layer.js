;(function definelayer(global, factory) {
    var layer = factory(global);
    if (typeof exports === 'object' && exports && typeof exports.nodeName !== 'string') {
        global.layer = layer;
        module.exports = layer
    } else if (typeof define === 'function' && define.amd) {
        global.layer = layer;
        define(['exports'], layer)
    } else {
        global.layer = layer
    }
    ...
    var config = {type: 0, shade: true, shadeClose: true, fixed: true, anim: 'scale'};
    var ready = {
        extend: function (obj) {
    ...
    var index = 0, classs = ['layui-m-layer'];
    ...
    return {
        v: '1.1', index: index, open: function (options) {
